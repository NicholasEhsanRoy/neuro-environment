# This was never used, but I did learn that doing it with this approach didn't work very well.
# Just happened to have overflow outside the desired bounding box, which was later corrected with cropping
